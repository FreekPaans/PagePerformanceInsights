<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="PagePerformanceInsights.TestApps.MVC3s.WebForms.Account.OpenAuthProviders" %>
